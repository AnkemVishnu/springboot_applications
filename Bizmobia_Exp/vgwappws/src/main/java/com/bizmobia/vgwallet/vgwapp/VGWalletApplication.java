package com.bizmobia.vgwallet.vgwapp;
...
@Configuration
@EnableMBeanExport(defaultDomain = "third")
@EnableJpaAuditing
@EntityScan("com.bizmobia.vgwallet.vgwapp.models")
@EnableAutoConfiguration
@EnableSpringDataWebSupport
@EnableJpaRepositories(basePackages = "com.bizmobia.vgwallet.vgwapp.dao")
@ComponentScan(basePackages = "com.bizmobia.vgwallet.vgwapp")
