...
public class MailSendingMsg {
    ...
    public static void sendPasswordMail(String tomail, String message) throws MessagingException {
        ...
        String content = "<html>\n"
                ...
                //                + "<td style=\"padding:0;margin:0;line-height:1px;font-size:1px\" align=\"right\"> <a href=\"#m_-1248683720590822411_\" style=\"text-decoration:none;border-style:none;border:0;padding:0;margin:0\"> <img src=\"https://bizmobia.com/img/bbbb.png#https://bizmobia.com/\" style=\"width:32px;margin:0;padding:0;display:block;border:none;outline:none\" class=\"CToWUd\" width=\"32\" align=\"right\"> </a> </td>\n"
                + "<td class=\"m_-1248683720590822411margin\" style=\"padding:0;margin:0;line-height:1px;font-size:1px\" width=\"24\"></td>\n"
                + "</tr>\n"
                + "<tr>\n"
        ...
        MailSenderGmail.sendWithoutAttachmentMail(fromemailid, fromPassword, tomail, "Password for login", content);
    }
